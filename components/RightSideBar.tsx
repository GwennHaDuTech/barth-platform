...
const RightSidebar = () => {
  return (
    <aside className="w-80 p-8 hidden lg:block overflow-y-auto h-screen">
      ...
      <GlassCard className="mb-4 !p-4 flex items-center gap-4 !bg-barth-dark-soft/50 !border-barth-gold/5">
        ...
        <div className="flex-1 leading-tight">
          ...
          <p className="text-xs text-gray-400 mt-1">Il y a 9 heures</p>
        </div>
      </GlassCard>

      <button className="w-full py-3 rounded-full bg-gradient-to-r from-barth-gold to-[#B08D57] text-barth-dark font-bold text-sm shadow-lg shadow-barth-gold/20 hover:opacity-90 transition">
